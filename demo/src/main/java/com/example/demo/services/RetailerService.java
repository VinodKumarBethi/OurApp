...
public class RetailerService {
    ...
    public RetailerDto getProfile(String token){
       final String uname=jwtutil.extractUsername(token);
        if(uname!=null){
            Retailer n=retailerRepo.getByRetailerUsername(uname);
            if(n.getRetailerId()!=null){
                return this.retailerToRetailerDTO(n);
            }
        }
